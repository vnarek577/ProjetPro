    ...
    <form method="POST">
        <div class="hello">
            <div class="main-content">
                <h4 class="text-white">Modifier l'adresse e-mail</h4>
                <div class="form-floating mb-2">
                    <input name="mailActuel" type="text" style="height: 50px;" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?= $_SESSION['user_mail']   ?>" disabled>
                    <label style="font-size: 15px;" for="floatingInput">E-mail actuel</label>
                </div>
                <div class="form-floating">
                    <input name="newMail" type="email" style="height: 50px;" class="form-control w-150" id="floatingInput" placeholder="name@example.com">
                ...
                <div>
                    <button id="he" name="updateEmailIndividual" type="submit" class="btn btn-sm btn-primary" value="<?= $_SESSION['user_id'] ?>">Change</button>
                    <?php if (isset($errors['mail'])) { ?>
                        <a href="user.php"><button name="updateProfileIndividual" type="button" class="btn btn-sm btn-secondary" value="">Annuler</button></a>
                    <?php } else { ?>
